                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <h3>Email</h3>
                            <span>alcarriacaio@gmail.com</span>
                            <a className="contact__button" href="mailto:alcarriacaio@gmail.com">Acessar <i className="bx bx-right-arrow-alt" /></a>
                        </div>
                        ...
                        <i className="bx bxl-linkedin" />
                            ...
                            <h3>Linkedin</h3>
                            <span>Caio Alcarria</span>
                            <a className="contact__button" href="https://www.linkedin.com/in/caioalcarria/">Acessar <i className="bx bx-right-arrow-alt"></i></a>
                        </div>
                    </div>
                </div>
